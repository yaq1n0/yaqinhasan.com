...
function handlePortrait() {
  /* 
    ...
    */
  let landscape_elements = document.getElementsByClassName(
    "show-landscape-only"
  );
  ...
  if (w <= width_warning) {
    alert(
      "your device's viewport is narrower than this site was designed and tested for, I suggest you try landscape mode. "
    );
  }
