...
export const cvSchema = z
  .object({
      ...
      .array(
        z
          .object({
            ...
            courses: z.array(z.string().describe("e.g. H1302 - Introduction to American history")).describe("List notable courses/subjects").optional()
          })
          .catchall(z.any())
      )
      .optional(),
    ...
    languages: z
      .array(
        z
          .object({ language: z.string().describe("e.g. English, Spanish").optional(), fluency: z.string().describe("e.g. Fluent, Beginner").optional() })
          .catchall(z.any())
      )
    ...
    interests: z
      .array(
        z
          .object({ name: z.string().describe("e.g. Philosophy").optional(), keywords: z.array(z.string().describe("e.g. Friedrich Nietzsche")).optional() })
          .catchall(z.any())
      )
      .optional(),
    references: z
