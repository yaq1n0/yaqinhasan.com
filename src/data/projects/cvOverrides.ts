...
export const cvOverrides: { id: string; overrides?: CVOverride }[] = [
  {
    ...
    overrides: {
      ...
      description:
        "Cryptographically secure secret splitting & reconstruction desktop app built with Rust & Tauri.",
  ...
  },
  {
    ...
    overrides: {
      ...
      description:
        "Spotlight-inspired menu bar utility for launching & scheduling local script-based workflows, built with Swift & SwiftUI.",
